...
from test_shjchan.test_shjchanImpl import test_shjchan
from test_shjchan.test_shjchanServer import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class test_shjchanTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('test_shjchan'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = test_shjchan(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_test_shjchan_" + str(suffix)
